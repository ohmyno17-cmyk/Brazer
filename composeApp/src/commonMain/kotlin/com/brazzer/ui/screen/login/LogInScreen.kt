package com.brazzer.ui.screen.login
...
import com.brazzer.expect.ui.PlatformWebView
import com.brazzer.expect.ui.createWebViewCookieManager
import com.brazzer.expect.ui.rememberWebViewState
import com.brazzer.ui.component.DevLogInBottomSheet
import com.brazzer.ui.component.DevLogInType
...
import brazzer.composeapp.generated.resources.log_in
import brazzer.composeapp.generated.resources.login_failed
import brazzer.composeapp.generated.resources.login_success
    ...
    LaunchedEffect(state) {
        snapshotFlow { state.value }.collect {
            Logger.d(
                ...
                "WebViewState: ${
                    when (it) {
                        is com.brazzer.expect.ui.WebViewState.Finished -> "Finished"
                        is com.brazzer.expect.ui.WebViewState.Loading -> "Loading ${it.progress}%"
                    }
                }",
            )
        }
