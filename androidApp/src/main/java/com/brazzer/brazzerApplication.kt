...
import com.brazzer.service.backup.AutoBackupScheduler
...
import org.brazzer.crashlytics.configCrashlytics
import java.lang.reflect.Field

class brazzerApplication :
    Application(),
    KoinComponent,
    ...
    override fun onCreate() {
        ...
        startKoin {
            ...
            androidContext(this@brazzerApplication)
            loadAllModules()
